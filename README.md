<h1 align="center"> 🚀 RUBY Básico </h1>

## ✍️ Descrição
Exemplificação da sintaxe geral e básica da Linguagem RUBY
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-ruby.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[REPLIT](https://replit.com/@cleibp/Basic-Ruby) 
